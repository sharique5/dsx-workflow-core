  ...
  private async sendWhatsAppPaymentSuccess(
    ...
    const message = {
      ...
      template: {
        ...
        locale: 'en',
        parameters: [
          { type: 'text', key: '1', value: name },
          { type: 'text', key: '2', value: amount.toLocaleString('en-IN') },
          { type: 'text', key: '3', value: paymentId },
          { type: 'text', key: '4', value: caseTitle },
          { type: 'text', key: '5', value: remainingBalance.toLocaleString('en-IN') },
          { type: 'text', key: '6', value: dynamicMessage },
        ],
      },
    };
  ...
  private async sendWhatsAppPaymentFailure(
    ...
    const message = {
      ...
      template: {
        ...
        parameters: [
          { type: 'text', key: '1', value: name },
          { type: 'text', key: '2', value: caseTitle },
          { type: 'text', key: '3', value: amount.toLocaleString('en-IN') },
          { type: 'text', key: '4', value: outstandingBalance.toLocaleString('en-IN') },
          { type: 'text', key: '5', value: reason },
        ],
      },
    };
