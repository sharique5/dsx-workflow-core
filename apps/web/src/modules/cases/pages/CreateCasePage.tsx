    ...
    <div className="px-6 py-8 max-w-2xl mx-auto">
      ...
      <div className="rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-slate-100">
          ...
          <p className="mt-0.5 text-sm text-slate-500">Fill in the details to open a new {vocab.matter_label.toLowerCase()} file.</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="px-6 py-6 space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className={LABEL_CLS}>Court Ref</label>
              <input
                type="text"
          ...
          {error && (
            <div className="flex items-center gap-2 rounded-lg bg-red-50 border border-red-200 px-3.5 py-2.5">
              ...
              <p className="text-sm text-red-600">Failed to create {vocab.matter_label.toLowerCase()}. Please try again.</p>
            </div>
          )}
