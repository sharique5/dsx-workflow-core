...
function BrandMark() {
  const { firmName, primaryColor } = useBrand();
  return (
    <div className="flex flex-col items-center gap-3 mb-8">
      <BrandLogo size="xl" className="shadow-lg" />
      <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: primaryColor }}>{firmName}</p>
    </div>
  );
}
